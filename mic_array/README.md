...
2. There are three types of arrays so far. 'individual' means the user can define the positions of microphones in arrat directly (you can see 'mic_config2.yaml' as reference).
